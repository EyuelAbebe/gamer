...
class Piece(object):
    ...
    def valid_moves(self, board):
        u"""Return a set of coords representing valid moves on current coord."""
...
class Match(object):
    ...
    def move(self, start_a1, end_a1):
        u"""Update board with the moved piece if move is valid.
    ...
    def _make_square(self):
        u"""Return list of lists representing units on board via integers."""
    ...
    def _inter(self, *args):
        u"""Return a unicode string with a line of the chessboard.
    ...
    def _in_check(self, color):
        u"""Return True if king of color is in check."""
        moves = set()
    ...
    def _checkmate(self, color):
        u"""Return True if king of color is in checkmate."""
        king = self._find_king(color)
    ...
    def _find_king(self, color):
        u"""Return King instance of a given color."""
        king = None
        for piece in self.board.values():
            # print piece
            if piece is not None:
    ...
    def _board_to_str(self):
        u"""Return 71 char string representing board."""
        square = []
    ...
    def _str_to_board(self, str_):
        u"""Return dictionary of coords to units based on string rep."""
        units = {
            'r': Rook,
            'n': Knight,
            'b': Bishop,
