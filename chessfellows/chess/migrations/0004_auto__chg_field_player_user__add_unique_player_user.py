...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'chess_player', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Player', fields ['user']
        db.create_unique(u'chess_player', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Player', fields ['user']
        db.delete_unique(u'chess_player', ['user_id'])


        # Changing field 'Player.user'
        db.alter_column(u'chess_player', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'chess.player': {
            ...
            'matches': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'Player'", 'symmetrical': 'False', 'to': u"orm['chess.Match']"}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'rating': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1200'}),
